...
public class BookStoreTest {
	...
	public static void main(String[] args) {
		...
		//4. 채식주의자 가격 할인 set
		// (1)가격 할인된 채식 주의자 책 정보를 새로 생성 
		System.out.println("4. 채식주의자 변경 ");
		Book vegeterian2 = new Book(1, "9788936433598(8936433598)", "채식주의자", "한강",  "창비", 247, 10000, 10);
		
		// (2) 변경된 책 정보를 담은 책 객체를 넘겨서 수정처리 
		kyobo.set(vegeterian2);
		...
		System.out.println("7. 모든 책 목록 조회");
