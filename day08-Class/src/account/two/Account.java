...
//		balance = 0;
	 ...
	 * 중복정의된 생성자. 
	 * 
	 * 중복정의(Overloading)--프로그램적인 기법, 코드를 깨끗이 만들 수 있다. 
	 * -------------------------------------------------------------------------
	 * 메소드의 이름은 같고, 매개변수 목록이 다른 메소드를 
	 * 정의하는 기법
	 * 중복정의는 생성자에도 적용되는 정의 기법
	 * (리턴타입이 없는 특별한 경우의 메소드이기 때문) 
	 * 
	 * 매개변수 목록이 다르다 
	 * 		(1) 개수가 다르다
	 * 		(2) 개수가 같을 때는 매개변수의 타입의 순서가 다르다
	 * 
	 * @param strAccNumber
	 * @param newBalance
	 */
	...
	public String withdraw(int amount) {
		...
		if (balance < amount) {
			...
			balance -= amount;
			result = amount + "원이 출금되었습니다. 잔액은 " + balance + "원입니다.";
		}
