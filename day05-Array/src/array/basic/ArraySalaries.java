 ...
 * 저장하는 배열을 Test 하는 클래스 
 * 
 */
public class ArraySalaries {

	public static void main(String[] args) {
		//1. 선언 : 배열 참조 변수 : 배열이름 복수형으로 줄 것.	
		int[] salaries;
		
		//2. 초기화 : 배열 참조 변수는 기본형이 아니므로 
		//					초기화를 위해 new 를 사용해야한다. 
		salaries = new int[10];//인덱스 할당 + 초기화
...
//		System.out.println("나이:" + age);
		...
		System.out.println("(2) 값 할당 후 출력");
		System.out.printf("salaries[0]=%d%n", salaries[0]);
		System.out.printf("salaries[1]=%d%n", salaries[1]);
		System.out.printf("salaries[2]=%d%n", salaries[2]);
		System.out.printf("salaries[3]=%d%n", salaries[3]);
		...
		System.out.println("salaries 배열의 길이 : "
										+ salaries.length);
...
//		System.out.printf("salaries[-1]=%d%n", salaries[-1]);
		...
		//=============================================
		// for loop 와 배열의 조합
		System.out.println("===for loop로 출력===");
